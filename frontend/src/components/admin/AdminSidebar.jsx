...
const MAIN_MENU = [
  ...
  { id: 'unverified-users', text: 'Pengguna Belum Verifikasi', icon: <PersonAdd />, path: '/admin/unverified-users' },
  ...
  { id: 'audit-logs',       text: 'Riwayat Audit',       icon: <History />,      path: '/admin/audit-logs', superAdminOnly: true },
